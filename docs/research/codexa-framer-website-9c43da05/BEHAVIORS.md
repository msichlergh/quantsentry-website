...
- Blog cards and related-article cards link to local `/codexa/company/blog/[slug]` routes.
- Buttons that represent unavailable account or purchasing actions retain their visual behavior without transmitting user data to the source.
- Legal/footer links stay within the `/codexa` namespace.
